...
public class PickerThreeDialog
{
    ...
    public PickerThreeDialog(Context context, List<PickerBean> list, PickerCallback callback)
    {
        this(context, null, list, callback);
    }

    public PickerThreeDialog(Context context, final String title, List<PickerBean> list, PickerCallback callback)
    {
        pickerCallback = callback;
        pickerView = new OptionsPickerNetView(new OptionsPickerNetView.Builder(context).setLayoutRes(R.layout.picker_layout, new CustomListener()
        {
            @Override
