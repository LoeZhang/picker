...
public class PickerDialog
{
    ...
    public PickerDialog(Context context, List<PickerBean> list, PickerCallback callback)
    {
        this(context, list,null, callback);
    }

    public PickerDialog(Context context, List<PickerBean> list, final String title, PickerCallback callback)
    {
