 ...
 * 条件选择器
 */
public abstract class OptionsPickerNetView extends BasePickerView implements View.OnClickListener
{
    private WheelNetOptions wheelOptions;
    ...
    //构造方法
    public OptionsPickerNetView(Builder builder)
    {
    ...
    private void initView(Context context)
    {
        ...
        if (customListener == null)
        {
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(Str_Submit) ? context.getResources()
                    .getString(R.string.pickerview_submit) : Str_Submit);
            btnCancel.setText(TextUtils.isEmpty(Str_Cancel) ? context.getResources()
                    .getString(R.string.pickerview_cancel) : Str_Cancel);
            ...
            rv_top_bar.setBackgroundColor(Color_Background_Title == 0 ? pickerview_bg_topbar :
                    Color_Background_Title);
        ...
        {
            customListener.customLayout(LayoutInflater.from(context)
                    .inflate(layoutRes, contentContainer));
        }

        // ----滚轮布局
        final LinearLayout optionsPicker = (LinearLayout) findViewById(R.id.optionspicker);
        optionsPicker.setBackgroundColor(Color_Background_Wheel == 0 ? bgColor_default :
                Color_Background_Wheel);

        wheelOptions = new WheelNetOptions(this, optionsPicker);
    ...
    public abstract void onSelect(int options1, int options2, int options3, PickerBean item1,
                                  PickerBean item2, PickerBean item3);
    ...
    public void returnData()
    {
        try
        {
            ...
            onSelect(items[0], items[1], items[2], wheelOptions.mOptions1Items.get(items[0]),
                    wheelOptions.mOptions2Items != null ? wheelOptions.mOptions2Items
                            .get(items[1]) : null, wheelOptions.mOptions3Items != null ?
                            wheelOptions.mOptions3Items
                                    .get(items[2]) : null);
        }catch (Exception e)
        {
        }
    ...
    public void setPicker(List<PickerBean> options1Items, List<PickerBean> options2Items,
                          List<PickerBean> options3Items)
    {
        wheelOptions.setPicker(options1Items, options2Items, options3Items);
    }

    public abstract void loadList2(int i1, PickerBean parent, OnLoadOkListener onLoadOkListener);

    public abstract void loadList3(int i1,int i2, PickerBean parent, OnLoadOkListener onLoadOkListener);
